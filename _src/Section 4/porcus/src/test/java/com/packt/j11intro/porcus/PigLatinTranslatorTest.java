...
public class PigLatinTranslatorTest {
    ...
    public void test_02_convertWord() {
        assertThat(t.convertWord("")).isEqualTo("");
    ...
    @Test
    public void test_03_convert() {
        assertThat(t.convert("Merry had a little lamb.")).isEqualTo("Errymay adhay away ittlelay amblay.");
        assertThat(t.convert("I'm very happy to take this Java course!")).isEqualTo("I'mway eryvay appyhay otay aketay isthay Avajay oursecay!");
    }
}